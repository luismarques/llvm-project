//===-- NativeRegisterContextLinux_riscv.h ---------------------*- C++ -*-===//
//
...
#include "Plugins/Process/Utility/lldb-riscv-linux-register-enums.h"
#include <sys/uio.h>
...
protected:
  ...
  size_t GetFPRSize() override { return 32 * 8; }
