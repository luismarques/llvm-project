...
; RV32I-NEXT:    bnez a0, .LBB1_[[IFTRUE:[0-9]+]]
; RV32I-NEXT:  # %bb.{{[0-9]+}}:
; RV32I-NEXT:    jump .LBB1_[[JMP:[0-9]+]], a0
; RV32I-NEXT:  # %bb.{{[0-9]+}}:
; RV32I-NEXT:    unimp
; RV32I-NEXT:    unimp
; RV32I-NEXT:  .LBB1_[[IFTRUE]]: # %iftrue
; RV32I-NEXT:    #APP
; RV32I-NEXT:    #NO_APP
; RV32I-NEXT:    #APP
; RV32I-NEXT:    .zero 1048576
; RV32I-NEXT:    #NO_APP
; RV32I-NEXT:    j .LBB1_[[TAIL:[0-9]+]]
; RV32I-NEXT:  # %bb.{{[0-9]+}}: # %iftrue
; RV32I-NEXT:    unimp
; RV32I-NEXT:    unimp
; RV32I-NEXT:  .LBB1_[[JMP]]: # %jmp
; RV32I-NEXT:    #APP
; RV32I-NEXT:    #NO_APP
; RV32I-NEXT:  .LBB1_[[TAIL]]: # %tail
; RV32I-NEXT:    li a0, 1
; RV32I-NEXT:    addi sp, sp, 16
; RV32I-NEXT:    ret
; RV32I-NEXT:  # %bb.{{[0-9]+}}: # %tail
; RV32I-NEXT:    unimp
; RV32I-NEXT:    unimp
; RV32I-NOT:     unimp
;
...
; RV32IC-NEXT:    bnez a0, .LBB1_[[IFTRUE:[0-9]+]]
; RV32IC-NEXT:  # %bb.{{[0-9]+}}:
; RV32IC-NEXT:    jump .LBB1_[[JMP:[0-9]+]], a0
; RV32IC-NEXT:  # %bb.{{[0-9]+}}:
; RV32IC-NEXT:    unimp
; RV32IC-NEXT:    unimp
; RV32IC-NEXT:  .LBB1_[[IFTRUE]]: # %iftrue
; RV32IC-NEXT:    #APP
; RV32IC-NEXT:    #NO_APP
; RV32IC-NEXT:    #APP
; RV32IC-NEXT:    .zero 1048576
; RV32IC-NEXT:    #NO_APP
; RV32IC-NEXT:    j .LBB1_[[TAIL:[0-9]+]]
; RV32IC-NEXT:  # %bb.{{[0-9]+}}: # %iftrue
; RV32IC-NEXT:    unimp
; RV32IC-NEXT:    unimp
; RV32IC-NEXT:  .LBB1_[[JMP]]: # %jmp
; RV32IC-NEXT:    #APP
; RV32IC-NEXT:    #NO_APP
; RV32IC-NEXT:  .LBB1_[[TAIL]]: # %tail
; RV32IC-NEXT:    li a0, 1
; RV32IC-NEXT:    addi sp, sp, 16
; RV32IC-NEXT:    ret
; RV32IC-NEXT:  # %bb.{{[0-9]+}}: # %tail
; RV32IC-NEXT:    unimp
; RV32IC-NEXT:    unimp
; RV32IC-NOT:     unimp
;
