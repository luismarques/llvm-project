...
; RUN: llc -mtriple=riscv32 -verify-machineinstrs -mattr=+f \
; RUN:   < %s | FileCheck %s -check-prefix=RV32IF-ILP32
...
; RV32IF-NEXT:    ret
;
; RV32IF-ILP32-LABEL: fold_promote:
; RV32IF-ILP32:       # %bb.0:
; RV32IF-ILP32-NEXT:    lui a3, 524288
; RV32IF-ILP32-NEXT:    and a2, a2, a3
; RV32IF-ILP32-NEXT:    addi a3, a3, -1
; RV32IF-ILP32-NEXT:    and a1, a1, a3
; RV32IF-ILP32-NEXT:    or a1, a1, a2
; RV32IF-ILP32-NEXT:    ret
;
...
; RV32IF-NEXT:    ret
;
; RV32IF-ILP32-LABEL: fold_demote:
; RV32IF-ILP32:       # %bb.0:
; RV32IF-ILP32-NEXT:    addi sp, sp, -16
; RV32IF-ILP32-NEXT:    sw ra, 12(sp)
; RV32IF-ILP32-NEXT:    fmv.w.x ft0, a0
; RV32IF-ILP32-NEXT:    fsw ft0, 8(sp)
; RV32IF-ILP32-NEXT:    mv a0, a1
; RV32IF-ILP32-NEXT:    mv a1, a2
; RV32IF-ILP32-NEXT:    call __truncdfsf2
; RV32IF-ILP32-NEXT:    fmv.w.x ft0, a0
; RV32IF-ILP32-NEXT:    flw ft1, 8(sp)
; RV32IF-ILP32-NEXT:    fsgnj.s ft0, ft1, ft0
; RV32IF-ILP32-NEXT:    fmv.x.w a0, ft0
; RV32IF-ILP32-NEXT:    lw ra, 12(sp)
; RV32IF-ILP32-NEXT:    addi sp, sp, 16
; RV32IF-ILP32-NEXT:    ret
;
