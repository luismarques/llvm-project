...
; RUN: llc -mtriple=riscv64 -verify-machineinstrs -O2 < %s \
...
; RV64I-LABEL: imm64_8:
; RV64I:       # %bb.0:
; RV64I-NEXT:    lui a0, 596523
; RV64I-NEXT:    addiw a0, a0, 965
; RV64I-NEXT:    slli a0, a0, 32
; RV64I-NEXT:    srli a0, a0, 19
; RV64I-NEXT:    addi a0, a0, -1347
; RV64I-NEXT:    slli a0, a0, 12
; RV64I-NEXT:    addi a0, a0, -529
...
; For some constants we can optimize the materialization for size or speed

define i64 @imm_speed() nounwind {
; RV32I-LABEL: imm_speed:
; RV32I:       # %bb.0:
; RV32I-NEXT:    lui a0, 1048320
; RV32I-NEXT:    srli a0, a0, 12
; RV32I-NEXT:    mv a1, zero
; RV32I-NEXT:    ret
;
; RV64I-LABEL: imm_speed:
; RV64I:       # %bb.0:
; RV64I-NEXT:    lui a0, 256
; RV64I-NEXT:    addiw a0, a0, -256
; RV64I-NEXT:    ret
  ret i64 1048320 ; 0xF_FF00
}

define i64 @imm_size() nounwind optsize {
; RV32I-LABEL: imm_size:
; RV32I:       # %bb.0:
; RV32I-NEXT:    lui a0, 1048320
; RV32I-NEXT:    srli a0, a0, 12
; RV32I-NEXT:    mv a1, zero
