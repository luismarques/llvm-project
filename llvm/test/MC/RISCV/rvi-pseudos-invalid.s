...
sw a2, %hi(a_symbol), a3 # CHECK: :[[@LINE]]:8: error: operand must be a symbol with %lo/%pcrel_lo/%tprel_lo/%got_gprel_lo/%gprel_lo/%epic_lo modifier or an integer in the range [-2048, 2047]
